...
const Albumcard = ({ item, type }) => {

  const navigate = useNavigate()
  return (
    <div onClick={() => {
      console.log(`Navigating to /dashboard/${type}/${item.id}`);
      navigate(`/dashboard/${type}/${item.id}`);

    }} className='flex flex-col bg-[#172022] p-3 rounded-[10px] w-[236px] gap-4 group items-center min-w-[236px]'>
